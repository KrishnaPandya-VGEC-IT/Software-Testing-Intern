...
public class First {
	...
	public void checkFirstPageTitle()
	{
		...
		driver.get("https://krishnapandyaasu.github.io/CSE565GUIfirst/");
	...
	public void checkCheckboxesSecondPage()
	{
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.get("https://krishnapandyaasu.github.io/CSE565GUIfirst/second");
	...
	public void checkThirdPageImageLocation()
	{
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.get("https://krishnapandyaasu.github.io/CSE565GUIfirst/third");
